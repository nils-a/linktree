...
public class SectionNames
{
    ...
    public const string RightSidebar = nameof(RightSidebar);
    public const string Subtitle = nameof(Subtitle);
    public const string Breadcrumbs = nameof(Breadcrumbs);
    public const string Title = nameof(Title);
    public const string ChildPages = nameof(ChildPages);
}